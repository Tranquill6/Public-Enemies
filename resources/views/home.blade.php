<x-home-layout>
    ...
    <div class='flex flex-wrap flex-row pl-5 pr-5'>
        <div class='w-3/5 m-auto h-full inline-flex justify-center align-middle px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg'>
            <div class='pt-3 flex flex-col'>
                <h1 class="text-3xl font-bold text-center text-white">Welcome to Public Enemies!</h1>
                <div class='flex flex-col h-full text-white'>
                    <span class='text-xl mt-5'>
                        Public Enemies is a game set in the old times of the mafia in America! The time period is the early 1930s, organized crime is starting to decline as organizations like the Federal Bearu of Investigations become more equipped to deal with criminal organizations. The 1930s was a period of famous gangsters such as John Dillinger, Baby Face Nelson, Bonnie and Clyde, Pretty Boy Floyd, Machine Gun Kelly, and Ma Barker. It also became known as the Public Enemies Era when the FBI began to keep "Public Enemies" lists of wanted criminals charged with crimes.
                    </span>
                    <span class='text-xl text- mt-5'>
                    ...
                    <span class='text-2xl text-center mt-5'>
        ...
        <div class='w-2/5 inline-flex align-middle justify-center overflow-hidden'>
            <img src='{{ asset('img/gangster.png') }}' />
        </div>
    </div>
</x-home-layout>